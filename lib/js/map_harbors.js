...
// OpenLayers.ProxyHost = "../../cgi-bin/playground/asbs/proxy.cgi?url=";
...
function changeOpt(lyr) {
    ...
    if ((optEl) && (optEl.length != 0)) {
        ...
        if (lyr.metadata["selOpts"]["selOptsType"] == "wms") {
          imgSrc = lyr.url+"REQUEST=GetLegendGraphic&STYLES=&FORMAT=image%2Fpng&LAYER="+lyr.params.LAYERS+"&LAYERS="+lyr.params.LAYERS;
        } else {
